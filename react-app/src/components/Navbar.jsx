...
const Navbar = () => {
  ...
  useEffect(() => {
    const savedStateActiveLink = JSON.parse(
          ...
          <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
            ...
            >
              <span
                ...
                onClick={() =>
                  isMobileDevice ? setOpenMobileMenu(!openMobileMenu) : ""
                }
              ></span>
              {!openMobileMenu ? (
                <svg
        ...
        <div className="sm:hidden" id="mobile-menu">
          <div className="space-y-1 px-2 pb-3 pt-2">
            <Link
              ...
              className={
                activeLink === 1
                  ? classNameNavbar.activeLinkMobile
                  : classNameNavbar.inactiveLinkMobile
              }
              onClick={() => {
                setActiveLink(1);
                sessionStorage.setItem("activeLink", 1);
