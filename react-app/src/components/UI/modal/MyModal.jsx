                ...
                <form onSubmit={getData}>
                    <div onClick={(e) => e.stopPropagation()} className={cl.myModalContent}>
                        <div className="border-b border-gray-900/10 pb-6">
                            <h2 className="text-base font-semibold leading-7 text-gray-900">Редактирование профиля
                                💫</h2>
                            <p className="mt-1 text-sm leading-6 text-gray-600">Эта информация будет доступна всем, так
                                что будьте осторожны :).</p>
                            <div className="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div className="col-span-full border-b border-gray-900/10">
                                    <label htmlFor="about"
                                           className="block text-sm font-medium leading-6 text-gray-900">Обо мне</label>
                                    <div className="mt-1">
                                ...
                                <div className="col-span-full">
                                    <label htmlFor="cover-photo"
                                           className="block text-sm font-medium leading-1 text-gray-900">Фото 📸</label>
                                    <div
                                        className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-7 py-5">
                        ...
                        <div className="border-b border-gray-900/10 pb-6">
                            ...
                            <div className="mt-1 grid grid-cols-1 gap-x-6 sm:grid-cols-6">
                                ...
                                <div className="sm:col-span-4">
                                    <label htmlFor="email"
                                           className="block text-sm font-medium leading-6 text-gray-900">Возраст</label>
                                    <div className="mt-2">
                                        <input id="email" name="email" type="number" autoComplete="email"
                                               className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                                    </div>
                                </div>
                                ...
                                <div className="mt-3 sm:col-span-4">
                                    <label htmlFor="sm"
                                           className="block text-sm font-medium leading-6 text-gray-900">Ссылки на соц. сети (введите через пробел)</label>
                                    <div>
                                        <input id="sm" name="sm" type="url" autoComplete="username webauthn"
                                               className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <div className="mt-3 grid grid-cols-1 gap-x-6 sm:grid-cols-6">
                                <div className="sm:col-span-4 sm:col-start-1">
                                    <label htmlFor="city"
                                           className="block text-sm font-medium leading-6 text-gray-900">Выберите то, чем любите заниматься 🔥</label>
                                    <div className="mt-100">
                    ...
                    <div className="mt-6 flex items-center justify-end gap-x-6">
                        <button type="button" className="text-sm font-semibold leading-6 text-gray-900">Отмена</button>
                        <button onClick={(e) => {getData(e)}} className="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Далее
                        </button>
                    </div>
                </form>
            </div>
