            ...
            <form onSubmit={getData}>
                        ...
                        <div className="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div className="col-span-full border-b border-gray-900/10">
                                <label htmlFor="about" className="block text-sm font-medium leading-6 text-gray-900">Обо
                                    мне</label>
                                <div className="mt-1">
                                    <textarea value={data.about} id="about" name="about" rows="3"
                    ...
                    <div className="border-b border-gray-900/10 pb-6">
                        ...
                        <div className="mt-1 grid grid-cols-1 gap-x-6 sm:grid-cols-6">
                            ...
                            <div className="sm:col-span-4">
                                ...
                                <div className="mt-2">
                                    <input value={data.age} id="email" name="email" type="number" autoComplete="email"
                            ...
                            <div className="mt-3 sm:col-span-4">
                                <label htmlFor="sm"
                                       className="block text-sm font-medium leading-6 text-gray-900">Ссылки на соц. сети
                                    (введите через пробел)</label>
                                <div>
                                    <input value={data.links} id="sm" name="sm" type="url" autoComplete="username webauthn"
                    ...
                    <div>
                        ...
                        <div className="mt-3 grid grid-cols-1 gap-x-6 sm:grid-cols-6">
                            <div className="sm:col-span-4 sm:col-start-1">
                                <label htmlFor="city"
                                       className="block text-sm font-medium leading-6 text-gray-900">Выберите то, чем
                                    любите заниматься 🔥</label>
                                <div className="mt-100">
                ...
                <div className="mt-6 flex items-center justify-end gap-x-6">
                    ...
                    <button onClick={(e) => {getData(e)}}
                            className="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Далее
                    </button>
                </div>
            </form>
        </div>
