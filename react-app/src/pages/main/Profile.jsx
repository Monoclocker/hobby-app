        ...
        <div className="container mx-auto p-4">
            {isDataLoading ? (
                ...
                <div className="max-w-screen-md mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
                    <MyModal
                        firstVisible={profileFirstModalVisible}
                        setFirstVisible={setProfileFirstModalVisible}
                    ...
                    <div className="px-6 py-8">
                        <div>
                            ...
                            <button
                                onClick={() => setProfileFirstModalVisible(true)}
                        ...
                        <div className="border-t border-gray-300 py-4 sm:py-6">
                            <h2 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-4 text-gray-800">Обо мне</h2>
                            <p className="text-base sm:text-lg text-gray-700">{profileData['about']}</p>
                        </div>
                        <div className="border-t border-gray-300 py-4 sm:py-6">
                            ...
                            <ul className="text-base sm:text-lg text-gray-700">
                                <li>
                                    {profileData['links']
                                        ? profileData['links'].map((link) => <a href={link}>{123}</a>)
                        ...
                        <div className="border-t border-gray-300 py-4 sm:py-6">
                            ...
                            <p className="text-base sm:text-lg text-gray-700">
                                {profileData['interests']
                                    ? profileData['interests'].map((text) => (
                                          <div className="text-lg font-semibold sm:mb-4 text-gray-800">
                                              {text + ' '}
                                          </div>
                                      ))
                                    : '**Может быть тут что-то будет 🙃**'}
